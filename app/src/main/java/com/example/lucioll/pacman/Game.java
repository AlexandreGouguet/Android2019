...
public class Game {
    ...
    public Game(){
        this.grille = new Integer[][]{
                ...
                {5,6,5,5,5,5,6,5,5,6,5,5,5,5,5,6,5,6,5},
                {5,6,5,5,5,5,6,5,5,6,5,5,5,5,5,6,5,6,5},
                {5,6,5,5,5,5,6,5,5,6,5,5,5,5,5,6,5,6,5},
                {5,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,5},
                {5,6,5,5,5,5,6,5,5,6,5,5,5,5,5,6,5,6,5},
        ...
        paci = new PacMan(this,4,1,4);
        Ghost g1 = new Ghost(this,1,2,3);
        Ghost g2 = new Ghost(this,4,9,4);
        Ghost g3 = new Ghost(this,1,11,3);
